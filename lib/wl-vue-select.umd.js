...
/* harmony default export */ var wl_tree_selectvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    // 处理默认选中数据
    chaeckDefaultValue: function chaeckDefaultValue(val) {
      var _this = this;
      ...
      if (this.checkbox) {
        var checked_keys = dist["DataType"].isObject(val[0]) ? val.map(function (i) {
...
var wl_tree_select_component = normalizeComponent(
  ...
  wl_tree_selectvue_type_template_id_4079989e_render,
  wl_tree_selectvue_type_template_id_4079989e_staticRenderFns,
  false,
  null,
  null,
  null
