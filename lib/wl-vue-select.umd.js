    ...
    chaeckDefaultValue: function chaeckDefaultValue() {
      ...
      if (this.checkbox) {
        ...
        if (typeof_typeof(val) === 'object') {
          this.selecteds = [val];
          this.$nextTick(function () {
            _this2.$refs["tree-select"].setCurrentNode(val);
          });
        } else {
          this.$nextTick(function () {
...
var wl_tree_select_component = normalizeComponent(
  ...
  wl_tree_selectvue_type_template_id_421aa08c_render,
  wl_tree_selectvue_type_template_id_421aa08c_staticRenderFns,
  false,
  null,
  null,
  null
