...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"7ebbd2a0-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/pages/wl-select/wl-vue-select.vue?vue&type=template&id=241b3dfb&
var render = function () {
var _obj;
...
// CONCATENATED MODULE: ./src/pages/wl-select/wl-vue-select.vue?vue&type=template&id=241b3dfb&
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"7ebbd2a0-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/pages/wl-tree/wl-tree-select.vue?vue&type=template&id=8b6e7e1e&
var wl_tree_selectvue_type_template_id_8b6e7e1e_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"wl-tree-select",style:({ width: _vm.width + 'px' })},[_c('el-popover',{attrs:{"placement":"bottom","trigger":_vm.trigger,"disabled":_vm.disabled,"width":_vm.width},model:{value:(_vm.options_show),callback:function ($$v) {_vm.options_show=$$v},expression:"options_show"}},[_c('el-scrollbar',{staticClass:"wl-treeselect-popover"},[_c('el-tree',{ref:"tree-select",staticClass:"wl-options-tree",attrs:{"highlight-current":"","default-expand-all":"","data":_vm.selfData,"props":_vm.selfProps,"node-key":_vm.nodeKey,"show-checkbox":_vm.checkbox,"expand-on-click-node":false,"default-checked-keys":_vm.checked_keys},on:{"check-change":_vm.handleCheckChange,"node-click":_vm.treeItemClick}})],1),_c('div',{staticClass:"selected-box",class:{'wl-disabled': _vm.disabled},attrs:{"slot":"reference"},slot:"reference"},[_c('div',{staticClass:"tag-box"},_vm._l((_vm.selecteds),function(item){return _c('el-tag',{key:item[_vm.nodeKey],staticClass:"wl-select-tag",attrs:{"size":"medium","closable":"","title":item[_vm.selfProps.label]},on:{"close":function($event){return _vm.tabClose(item[_vm.nodeKey])}}},[_vm._v("\n          "+_vm._s(item[_vm.selfProps.label])+"\n        ")])}),1),_c('div',{staticClass:"icon-box"},[_c('transition',{attrs:{"name":"fade-rotate","mode":"out-in"}},[(!_vm.options_show)?_c('i',{key:"top",staticClass:"el-icon-arrow-down"}):_c('i',{key:"btm",staticClass:"el-icon-arrow-up"})])],1)])],1)],1)}
var wl_tree_selectvue_type_template_id_8b6e7e1e_staticRenderFns = []


// CONCATENATED MODULE: ./src/pages/wl-tree/wl-tree-select.vue?vue&type=template&id=8b6e7e1e&
    ...
    chaeckDefaultValue: function chaeckDefaultValue() {
      ...
      if (!val || Array.isArray(val) && val.length === 0) {
        ...
        this.$nextTick(function () {
          _this2.$refs["tree-select"].setCheckedKeys([]);
        });
        return;
      } // 多选处理
      ...
      if (this.checkbox) {
        this.checked_keys = typeof_typeof(val[0]) === 'object' ? val.map(function (i) {
          return i[_this2.nodeKey];
        }) : val;
        this.$nextTick(function () {
          _this2.selecteds = _this2.$refs["tree-select"].getCheckedNodes(_this2.leaf);
        });
        return;
      } // 单选处理
      ...
      if (typeof_typeof(val) === 'object') {
        ...
        this.selecteds = [_val];
        this.$nextTick(function () {
          _this2.$refs["tree-select"].setCurrentNode(_val);
        });
      } else {
        this.$nextTick(function () {
          _this2.$refs["tree-select"].setCurrentKey(val);

          var _node = _this2.$refs["tree-select"].getCurrentNode();

          _this2.selecteds = _node ? [_node] : [];
        });
      }
    }
  },
...
var wl_tree_select_component = normalizeComponent(
  ...
  wl_tree_selectvue_type_template_id_8b6e7e1e_render,
  wl_tree_selectvue_type_template_id_8b6e7e1e_staticRenderFns,
  false,
  null,
  null,
  null
